<div class="sidebar-main sidebar-menu-one sidebar-expand-md sidebar-color">
    <div class="mobile-sidebar-header d-md-none">
         <div class="header-logo">
             <a href="index.html"><img src="{{ static_asset('assets/img/logo1.png')}}" alt="logo"></a>
         </div>
    </div>
     <div class="sidebar-menu-content">
         <ul class="nav nav-sidebar-menu sidebar-toggle-view">
             ...
             <li class="nav-item sidebar-nav-item">
                 ...
                 <ul class="nav sub-group-menu">
                     <li class="nav-item">
                         <a href="notification-alart.html" class="nav-link"><i class="fas fa-angle-right"></i>Add User</a>
                     </li>
                     <li class="nav-item">
                         <a href="{{route('admin.user.list','admin')}}" class="nav-link"><i class="fas fa-angle-right"></i>Admin</a>
                     </li>
                     <li class="nav-item">
                         <a href="{{route('admin.user.list','teachers')}}" class="nav-link"><i class="fas fa-angle-right"></i>Teachers</a>
                     </li>
                     <li class="nav-item">
                         <a href="{{route('admin.user.list','students')}}" class="nav-link"><i class="fas fa-angle-right"></i>Students</a>
                     </li>
                     <li class="nav-item">
                         <a href="{{route('admin.user.list','parents')}}" class="nav-link"><i class="fas fa-angle-right"></i>Parents</a>
                     </li>
                 </ul>
             </li>
             <li class="nav-item">
