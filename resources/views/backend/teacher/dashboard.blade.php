            ...
            <div class="row">
                ...
                <div class="col-6-xxxl col-lg-3 col-sm-6 col-12">
                    <div class="dashboard-summery-two">
                        ...
                        <div class="item-content">
                            <div class="item-number"><span>$</span><span class="counter" data-num="2102050">21,02,050</span>
                            </div>
                            ...
                            <table class="table display data-table text-nowrap">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center"><img src="{{ static_asset('assets/img/figure/student2.png')}}" alt="student"></td>
                                        <td>Mark Willy</td>
                                        <td>Male</td>
                                        <td>2</td>
                                        <td>A</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><img src="{{ static_asset('assets/img/figure/student3.png')}}" alt="student"></td>
                                        <td>Jessia Rose</td>
                                        <td>Female</td>
                                        <td>1</td>
                                        <td>A</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><img src="{{ static_asset('assets/img/figure/student4.png')}}" alt="student"></td>
                                        <td>Mark Willy</td>
                                        <td>Male</td>
                                        <td>2</td>
                                        <td>A</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><img src="{{ static_asset('assets/img/figure/student5.png')}}" alt="student"></td>
                                        <td>Jessia Rose</td>
                                        <td>Female</td>
                                        <td>1</td>
                                        <td>A</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><img src="{{ static_asset('assets/img/figure/student6.png')}}" alt="student"></td>
                                        <td>Mark Willy</td>
                                        <td>Male</td>
                                        <td>2</td>
                                        <td>A</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><img src="{{ static_asset('assets/img/figure/student7.png')}}" alt="student"></td>
                                        <td>Jessia Rose</td>
                                        <td>Female</td>
                                        <td>1</td>
                                        <td>A</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><img src="{{ static_asset('assets/img/figure/student8.png')}}" alt="student"></td>
                                        <td>Mark Willy</td>
                                        <td>Male</td>
                                        <td>2</td>
                                        <td>A</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><img src="{{ static_asset('assets/img/figure/student9.png')}}" alt="student"></td>
                                        <td>Jessia Rose</td>
                                        <td>Female</td>
                                        <td>1</td>
                                        <td>A</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><img src="{{ static_asset('assets/img/figure/student10.png')}}" alt="student"></td>
                                        <td>Mark Willy</td>
                                        <td>Male</td>
                                        <td>2</td>
                                        <td>A</td>
